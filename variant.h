...
#define PIN_SERIAL3_TX (11ul)
#define PAD_SERIAL3_RX (SERCOM_RX_PAD_1)
#define PAD_SERIAL3_TX (UART_TX_PAD_0)

//Serial 4
extern Uart Serial4;
#define PIN_SERIAL4_RX (5ul)
#define PIN_SERIAL4_TX (4ul)
...
//
#define SERIAL3_PORT_HARDWARE        Serial3
#define SERIAL3_PORT_HARDWARE_OPEN   Serial3
#define SERIAL4_PORT_HARDWARE        Serial4
#define SERIAL4_PORT_HARDWARE_OPEN   Serial4
